...
function clean() {
	return glob('./www/**/*.{html,jpg,svg,webp,css,js,woff,woff2}', {}, function(er, files) {
...
const build = gulp.series(clean, compileNunjucks, compressImages, createWebP, compileSass, bundleJavaScript, generateCriticalCSS, copyFonts);
